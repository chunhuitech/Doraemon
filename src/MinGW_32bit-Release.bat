...
xcopy "%sourceCodePath%\build-DoraemonSolution-Desktop_Qt_5_5_1_MinGW_32bit-Release\Doraemon\release\config.ini" "%sourceCodePath%\MinGW_32bit-Release\" /d /c /f /y   >> %logFileName%
...
xcopy "%sourceCodePath%\DoraemonSolution\configs\config_windows_32.ini" "%sourceCodePath%\MinGW_32bit-Release\config.ini" /d /c /f /y   
